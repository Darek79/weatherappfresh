...
interface IGetWeatherIndexes {
    ...
    lineChartsDataArray: { temp: number; date: string }[];
}
var testArr1 = {
    cod: '200',
    message: 0,
...
export function getWeatherIndexes(obj: OPEN_WEATHER): IGetWeatherIndexes {
    ...
    const lineChartsDataArray: { temp: number; date: string }[] = [];
    ...
    allDaysSorted[0].forEach(el => {
        ...
        lineChartsDataArray.push({ temp: el.main.feels_like, date: el.dt_txt.split(' ')[1] });
    });
...
console.log(values.lineChartsDataArray);
